...
class TwigExecuteRequest
{
    ...
    public function setCompiled(string $compiled): TwigExecuteRequest
    {
    ...
    public function setToExecute(string $toExecute): TwigExecuteRequest
    {
