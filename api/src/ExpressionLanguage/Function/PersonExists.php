...
final readonly class PersonExists implements ExpressionFunctionInterface
{
    public const NAME = 'PERSON_EXISTS';
    ...
    {
        return fn(array $context, string $name): bool => !empty($this->personRepository->findOneBy(['name' => $name]));
    }
}
